...
This repository is separate from the old blog/content pipeline. It is intended to support multi-destination medical tourism data, including visa rules, patient country profiles, hospitals, doctors, flights, FAQs, testimonials/reviews, and future cost/success-rate datasets.
...
- Local SQLite is used for v1 development.
